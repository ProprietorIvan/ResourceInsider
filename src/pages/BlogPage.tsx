    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[var(--color-navy)]">
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-24 text-center md:px-8 md:py-28">
          ...
          <div className="mt-10">
            <Link to="/join"><BtnTeal className="px-10 py-4 text-base">Join Resource Insider</BtnTeal></Link>
          </div>
              ...
              <article key={post.slug} className="group flex flex-col overflow-hidden rounded-lg border-2 border-[var(--color-teal)]/30 bg-white shadow-sm transition hover:shadow-md hover:border-[var(--color-teal)]/60">
                ...
                <div className="flex flex-1 flex-col px-4 pb-4 pt-2">
                  <h2 className="text-sm font-bold leading-snug text-[var(--color-heading)]">
                    <Link to={`/blog/${post.slug}`} className="transition hover:text-[var(--color-teal)]">
                      {post.title}
                    </Link>
                  </h2>
                  ...
                  <Link to={`/blog/${post.slug}`} className="mt-3 inline-block text-xs font-bold uppercase tracking-wider text-[var(--color-heading)] hover:text-[var(--color-teal)]">
                    Read More &raquo;
                  </Link>
